...
export default function Sales() {
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      alert("กรุณาตรวจสอบสินค้า ราคา จำนวน กล่อง และค่าส่งให้ครบถ้วนและไม่ติดลบ");
      return;
    }
    setLoading(true);
    try {
    ...
    <div>
      ...
      <div className="sales-grid">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          {/* Sale info */}
          <div className="card">
            <h3 style={{ fontSize: 15, marginBottom: 16, color: "var(--gray-800)" }}>
              ข้อมูลการขาย
            </h3>
            ...
            <div
              style={{
                ...
                border: selectedCustomer?.address
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                      ...
                      <div key={row.rowId} className="box-item-row">
                        <div className="row-select">
                          <select
                            ...
                            value={row.productId}
                            onChange={(e) =>
                              updateRow(box.id, row.rowId, "productId", e.target.value)
                            }
                          >
                        ...
                        <div className="row-del">
                          <button
                            ...
                            onClick={() => removeRow(box.id, row.rowId)}
                          >
                            ✕
                          </button>
                        </div>
          ...
          <div className="card">
            <div style={{ marginBottom: 16 }}>
              <div
                style={{ fontSize: 13, fontWeight: 700, color: "var(--gray-600)", marginBottom: 8 }}
              >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                {[
                  { value: "free", label: "ส่งฟรี", sub: "ไม่มีค่าส่ง", price: "0" },
                  {
                    ...
                    price:
                      numBoxes >= 10 ? "0" : `${calcShippingPerBox(numBoxes).toLocaleString()}`,
                  },
          ...
          <div className="modal" style={{ maxWidth: 780 }} onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button className="btn-icon btn-secondary" onClick={() => setShowSlip(false)}>
                  ✕
                </button>
              </div>
            </div>
