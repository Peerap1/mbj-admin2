...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.username || !form.password) { setError("กรุณากรอกชื่อผู้ใช้และรหัสผ่าน"); return; }
    setLoading(true);
    setError("");
    try {
      const userData = await loginUser(form.username.trim(), form.password);
      if (userData) { login(userData); navigate("/sales"); }
        ...
        <form onSubmit={handleSubmit} className="login-form">
          <div className="login-field">
            ...
            <div className="input-wrap">
              ...
              <input type="text" placeholder="กรอกชื่อผู้ใช้" value={form.username}
          ...
          <div className="login-field">
            ...
            <div className="input-wrap">
              ...
              <input type={showPw ? "text" : "password"} placeholder="กรอกรหัสผ่าน" value={form.password}
